...
void loop() {
  ...
  lights_ALL_ON_Yel_P(476);
  lights(1,1,1,1,0,1,0,0,476);
  lights(1,1,1,1,0,1,0,0,476);
  lights(1,1,0,0,0,1,0,0,715);
  ...
  lights(0,0,0,1,0,1,0,0,177);
  lights_ALL_OFF(177);
  lights_Just_LeftArm(177);
  lights_ALL_OFF(177);
  lights_Just_RightArm(177);
  lights(0,1,0,0,1,0,0,0,177);
  lights_Just_Yel_P(177);
  lights_Just_LeftArm(177);
  ...
  lights(1,1,1,1,0,1,0,0,167);
  lights(0,0,1,1,1,1,1,0,50);
