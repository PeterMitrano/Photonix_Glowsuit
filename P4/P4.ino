...
void loop() {
  ...
  lights_ALL_ON_Yel_P(3365);
  lights(1,1,0,0,1,1,1,0,205);
  lights(1,1,0,0,0,0,1,0,170);
  lights_Just_Yel_P(436);
  lights_ALL_OFF(2353);
  lights_ALL_OFF(100);
  lights_ALL_ON_Yel_P(2143);
  lights_ALL_ON_Yel_P(6549);
  lights_ALL_OFF(280);
  lights_ALL_ON_Yel_P(70);
  lights_ALL_OFF(70);
  lights_ALL_OFF(70);
  lights_ALL_OFF(351);
  lights_ALL_OFF(70);
  ...
  lights(0,0,1,1,0,1,1,0,227);
  lights_BOTH_LEGS(333);
  lights_ALL_OFF(386);
  lights_BOTH_LEGS(35);
  lights(0,0,1,1,0,1,0,0,35);
  lights(0,0,1,1,1,1,1,0,35);
  ...
  lights_ALL_ON_Yel_P(1118);
  lights_ALL_ON_Yel_P(1361);
  lights_ALL_OFF(491);
  lights_BOTH_LEGS(482);
  lights_ALL_OFF(241);
  lights(0,0,0,0,1,0,1,0,360);
  lights_ALL_OFF(299);
  lights_ALL_OFF(239);
  lights_ALL_OFF(239);
  lights_ALL_OFF(4347);
  ...
  lights_ALL_OFF(298);
  lights_ALL_OFF(407);
  lights_ALL_ON_Yel_P(476);
  lights_ALL_OFF(7153);
  lights_ALL_OFF(476);
  lights_ALL_OFF(476);
  lights_ALL_OFF(476);
  lights_ALL_OFF(645);
  lights_ALL_ON_Yel_P(3760);
  ...
  lights_ALL_ON_Yel_P(100);
  lights_ALL_OFF(1566);
  lights_BOTH_LEGS(119);
  lights_ALL_ON_Yel_P(1786);
  lights_ALL_ON_Yel_P(119);
  lights_ALL_ON_Yel_P(2024);
  lights(0,0,1,1,1,1,1,0,476);
  lights(0,0,1,1,1,1,1,0,476);
  lights(0,0,1,1,1,0,1,0,476);
  lights(0,0,1,1,1,0,1,0,715);
  lights_ALL_ON_Yel_P(3809);
  lights_ALL_OFF(1667);
  lights_BOTH_LEGS(59);
  lights(0,0,1,1,0,1,0,0,60);
  lights(0,0,1,1,1,1,1,0,59);
  ...
  lights_ALL_OFF(60);
  lights_BOTH_LEGS(30);
  lights(0,0,1,1,0,1,0,0,30);
  lights(0,0,1,1,1,1,1,0,30);
  ...
  lights_ALL_OFF(100);
  lights_ALL_OFF(253);
  lights_ALL_ON_Yel_P(1059);
  lights_ALL_OFF(100);
  lights_ALL_ON_Yel_P(606);
  lights_ALL_ON_Yel_P(706);
  lights_ALL_OFF(705);
  lights_BOTH_ARMS(177);
  lights_BOTH_ARMS(177);
  lights_BOTH_ARMS(422);
  lights_ALL_OFF(4519);
  lights(0,0,1,1,0,0,0,0,353);
  lights(0,0,1,1,0,1,1,0,352);
  lights(1,1,1,1,0,1,1,0,353);
  lights_ALL_ON_Yel_P(4589);
  ...
  lights_Just_Red_P(177);
  lights_ALL_OFF(177);
  lights(0,1,0,0,0,0,1,0,177);
  lights_Just_LeftLeg(177);
  lights(1,0,0,0,0,1,0,0,125);
  lights_ALL_OFF(574);
  lights_ALL_OFF(353);
  lights_ALL_OFF(352);
  lights_ALL_OFF(353);
  ...
  lights(1,1,0,0,1,1,1,0,265);
  lights(1,1,1,1,1,0,1,0,167);
  lights(1,1,1,1,0,1,0,0,50);
  ...
  lights_Just_Yel_P(1764);
  lights_ALL_OFF(89);
  lights_Just_Yel_P(1676);
