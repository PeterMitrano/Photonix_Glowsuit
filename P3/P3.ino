...
void loop() {
  ...
  lights_ALL_OFF(70);
  lights_ALL_OFF(351);
  lights_ALL_ON_Yel_P(560);
  lights_ALL_ON_Yel_P(1683);
  lights_ALL_OFF(1121);
  lights_ALL_ON_Yel_P(1402);
  lights(1,1,0,0,1,1,1,0,70);
  lights(1,1,0,0,1,0,1,0,70);
  lights(1,1,0,0,0,0,0,0,70);
  lights_ALL_OFF(2424);
  lights_ALL_OFF(100);
  lights_ALL_ON_Yel_P(1682);
  lights_ALL_ON_Yel_P(631);
  lights_ALL_ON_Yel_P(1296);
  ...
  lights_ALL_OFF(177);
  lights_ALL_OFF(422);
  lights_ALL_ON_Yel_P(4519);
  lights(1,1,0,0,1,1,1,0,353);
  lights(1,1,0,0,1,0,0,0,352);
  lights(0,0,0,0,1,0,0,0,353);
  lights_ALL_OFF(4589);
  lights_ALL_OFF(353);
  lights_ALL_OFF(353);
  lights_ALL_OFF(353);
  ...
  lights(1,0,1,0,0,0,1,0,177);
  lights_Just_LeftArm(177);
  lights_Just_LeftLeg(177);
  lights_ALL_OFF(177);
  lights_Just_RightArm(177);
  lights(0,0,0,0,0,1,0,0,177);
  lights(1,0,0,0,0,0,0,0,177);
  lights(0,0,0,0,1,0,0,1,177);
  lights_Just_LeftLeg(177);
  lights_Just_RightArm(125);
  lights_ALL_OFF(574);
  lights_ALL_OFF(353);
  lights_Just_Yel_P(352);
  lights_ALL_OFF(353);
  lights_ALL_OFF(353);
  ...
  lights(1,1,1,1,1,0,1,0,265);
  lights(1,1,1,1,0,1,0,0,265);
  lights(0,0,1,1,1,1,1,0,167);
  lights(1,1,0,0,1,1,1,0,50);
